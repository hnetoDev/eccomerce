          ...
          <div className="flex space-x-4 mt-4 ">
            <div>
              <div className="bg-primary/5 p-2 border border-primary rounded-xl">
                <div className="flex items-center justify-center w-56 bg-white p-4 rounded-xl border-primary">
                  <QRCode className=""
              ...
              <button className="bg-primary p-3 flex items-center space-x-2 w-60 rounded-xl mt-2 justify-center">

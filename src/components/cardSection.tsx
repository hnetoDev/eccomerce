...
export default function CardSection(){
  return (
    <div className="w-full flex justify-around space-x-6 items-center">
      <div className="bg-muted min-w-[300px] w-full px-5 py-3 rounded-full flex space-x-2 items-center justify-center">
        <CreditCard className="w-10 h-10 text-primary"/>
        <h1 className="text-sm">Parcele em até 6x s/juros</h1>
      </div>
      <div className="bg-muted min-w-[300px] w-full px-5 py-3 rounded-full flex space-x-2 items-center justify-center">

        ...
        <div className="embla__container ">
          <div className="embla__slide  rounded-lg px-4 ">
            <div className='bg-primary rounded-lg'>
              <Image width={2000} height={2000} src={'/images/Suplementos.png'} alt="Slide 1" className=" rounded-xl break:h-[22rem] h-[20rem] w-0  invisible fixed md:relative md:visible md:w-full"  />
              <Image width={2000} height={2000} src="/images/cardMobile.png" alt="Slide 1" className=" rounded-xl md:w-0 md:fixed md:invisible visible relative break:h-[22rem] h-[20rem] w-full"  />
            </div>
          </div>
          <div className="embla__slide  rounded-lg px-4 ">
            <div className='bg-primary rounded-lg'>
              <Image width={2000} height={2000} src="/images/bannerMenthos.png" alt="Slide 1" className=" rounded-xl break:h-[22rem] h-[20rem] w-0  invisible fixed md:relative md:visible md:w-full"  />
              <Image width={2000} height={2000} src="/images/cardMobile2.png" alt="Slide 1" className=" rounded-xl md:w-0 md:fixed md:invisible visible relative break:h-[22rem] h-[20rem] w-full"  />
            </div>
          </div>
          <div className="embla__slide  rounded-lg px-4 ">
            <div className='bg-primary rounded-lg'>
              <Image width={2000} height={2000} src="/images/bannerIntegral2.jpg" alt="Slide 1" className=" rounded-xl break:h-[22rem] h-[20rem] w-0  invisible fixed md:relative md:visible md:w-full"  />
              <Image width={2000} height={2000} src="/images/cardMobile2.png" alt="Slide 1" className=" rounded-xl md:w-0 md:fixed md:invisible visible relative break:h-[22rem] h-[20rem] w-full"  />
            </div>
          </div>

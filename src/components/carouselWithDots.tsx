        ...
        <div className="embla__container ">
          <div className="embla__slide  rounded-lg px-4 ">
            <div className='bg-primary rounded-lg'>
              <Image width={2000} height={2000} src="https://bearshop-images-s3.s3.sa-east-1.amazonaws.com//images/teste/menthos.webp" alt="Slide 1" className=" rounded-xl break:h-[22rem] h-[20rem] w-0  invisible fixed md:relative md:visible md:w-full"  />
